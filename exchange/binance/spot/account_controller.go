...
type SpotAccountController struct {
	e            exchange.Exchange
	client       ws.Client
	rLock        sync.RWMutex
	stopC        chan struct{}
...
func (ac *SpotAccountController) Close() {
	ac.rLock.Lock()
...
func (ac *SpotAccountController) BalanceChannel() <-chan *exchange.Balance {
	return ac.balanceC
}
...
var _ exchange.AccountController = (*SpotAccountController)(nil)
